...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form method="POST" action="{{ route('storeentreegroupe') }}">
        @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="montant" id="montant" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>
